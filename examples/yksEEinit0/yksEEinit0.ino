...
void setup() {
  ...
  memset (&buffer, 0, 20);
  yubikey_modhex_decode ((char *) &buffer, YKS_AESKEY, 16);
  ...
  memset (&buffer, 0, 20);
  yubikey_modhex_decode ((char *) &buffer, YKS_PRIVATE, 6);
  yubikey_eeset_private(buffer);

  memset (&buffer, 0, 20);
  yubikey_modhex_decode ((char *) &buffer, YKS_PUBLIC, 6);
  yubikey_eeset_public(buffer, 6);

  memset (&buffer, 0, 20);
  yubikey_modhex_decode ((char *) &buffer, YKS_STATIC, 16);
